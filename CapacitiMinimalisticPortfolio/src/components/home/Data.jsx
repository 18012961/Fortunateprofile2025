...
const Data = () => {
  return (
   <div className="home__data">
    ...
    <h3 className="home__subtitle"> Software developer and UX Designer</h3>
    <p className="home__description"> 
       I seamlessly bridge the gap between design vision in Figma/Adobe XD 
       and high-performance execution using React and Next.js, ensuring every deployed product 
      is both beautiful and functionally flawless.</p>
<button
